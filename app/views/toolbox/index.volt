<div class="page-header">
	<h1>
		<span class="glyphicon glyphicon-wrench" style="color:hsl(0,0%,90%); vertical-align:top;"></span>
		Toolbox
	</h1>
</div>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="jumbotron bg-primary">
							...
							<p>
								<a class="btn btn-default btn-lg" role="button">Learn more</a>
								<a class="btn btn-primary btn-lg" role="button">Learn more</a>
								<a class="btn btn-success btn-lg" role="button">Learn more</a>
								<a class="btn btn-info btn-lg" role="button">Learn more</a>
								<a class="btn btn-warning btn-lg" role="button">Learn more</a>
								<a class="btn btn-danger btn-lg" role="button">Learn more</a>
								<a class="btn btn-link btn-lg" role="button">Learn more</a>
							</p>
						</div>
